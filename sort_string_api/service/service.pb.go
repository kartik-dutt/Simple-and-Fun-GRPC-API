...
type Request struct {
	...
	Inp string `protobuf:"bytes,1,opt,name=inp,proto3" json:"inp,omitempty"`
}
...
var file_service_service_proto_rawDesc = []byte{
	...
	0x22, 0x1b, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x69,
	0x6e, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x69, 0x6e, 0x70, 0x32, 0x38, 0x0a,
	0x0a, 0x41, 0x64, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2a, 0x0a, 0x04, 0x53,
	0x6f, 0x72, 0x74, 0x12, 0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x52, 0x65,
...
var file_service_service_proto_depIdxs = []int32{
	0, // 0: service.AddService.Sort:input_type -> service.Request
	0, // 1: service.AddService.Sort:output_type -> service.Request
...
type AddServiceClient interface {
	Sort(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Request, error)
}
...
func (c *addServiceClient) Sort(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Request, error) {
	out := new(Request)
	err := c.cc.Invoke(ctx, "/service.AddService/Sort", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddServiceServer interface {
	Sort(context.Context, *Request) (*Request, error)
}
...
func (*UnimplementedAddServiceServer) Sort(context.Context, *Request) (*Request, error) {
...
func _AddService_Sort_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).Sort(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.AddService/Sort",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).Sort(ctx, req.(*Request))
	}
...
var _AddService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Sort",
			Handler:    _AddService_Sort_Handler,
		},
	},
